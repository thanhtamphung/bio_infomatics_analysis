...
print "Generating folders for ouput ..."
...
for k in range(len(df_tab)):
    ...
    text = name + " " + name + " 0 0 " + df_tab['Sex'][k] + ' '             + df_tab['Age'][k] + ' '+ df_tab['PLq'][k] + ' '             + df_tab['HOX'][k]+ ' '+ df_tab['HCaLciU'][k]+ ' '             + df_tab['HCt3oL'][k]+ ' '+ df_tab['RCt3oLOH'][k]+ "\n"
    f.write(text)
...
def rvtest_gene(phenoname, gene):
    ...
    comm = rvtest_pwd + " --inVcf " + invcf + " --pheno " + pheno + " --pheno-name " +phenoname     + " --covar " + pheno + " --covar-name age,sex --qtl --freqUpper 0.05 "  + " --geneFile "+ genefile     + " --gene " + gene + " --out " + outrv +  " --kernel skat"
...
def rvtest(phenoname):
    ...
    comm = rvtest_pwd + " --inVcf " + invcf + " --pheno " + pheno + " --pheno-name " +phenoname     + " --covar " + pheno + " --covar-name age,sex --qtl --freqUpper 0.05"  + " --geneFile "+ genefile     + " --out " + outrv + " --kernel skat" # adjust covar
    print comm
    print subprocess.check_output(comm, shell = True)
