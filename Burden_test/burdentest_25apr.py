...
# In[9]:
print "================================================================================"
print "===================== 2/ Filter position with bed file =================================="
print "================================================================================"
...
# In[35]:
def pheno_extract(idx, phenoname):
    plq = []
    for i in range(len(df_tab)):
        tmp = df_tab["SAMPLES-NAMES"][i].split("-")
        plq.append(tmp[idx])
...
def rvtest_gene(phenoname, gene):
    ...
    com = rvtest_pwd + " --inVcf " + invcf + " --pheno " + pheno + " --pheno-name " + phenoname \
...
def rvtest(phenoname):
    ...
    com = rvtest_pwd + " --inVcf " + invcf + " --pheno " + pheno + " --pheno-name " + phenoname + " --covar " \
